...
function AnglesOfTriangle() {
  ...
  return (
    <div>
      ...
      <input type="number" onChange={(e) => setAngleA(e.target.value)} />
      <input type="number" onChange={(e) => setAngleB(e.target.value)} />
      <input type="number" onChange={(e) => setAngleC(e.target.value)} />
